  ...
  try {
    ...
    const formattedHistory = history.map(record => {
      ...
      switch(record.reason) {
        ...
        case "studio_task_reserve":
        case "studio_task_extra_charge":
          type = "usage";
          break;
        case "refund":
        ...
        case "studio_task_reserve_refund":
        case "studio_task_failed_refund":
        case "studio_task_canceled_refund":
        case "studio_task_settlement_refund":
          type = "refund";
          break;
        case "adjustment":
          type = "adjustment";
