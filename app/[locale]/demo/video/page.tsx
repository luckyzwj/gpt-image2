...
export default function VideoPage() {
  ...
  const handleGenerateVideo = async () => {
    ...
    try {
      ...
      // Replace loading placeholder with the newly created task item.
