...
import { uploadDemoImage } from "@/lib/client-api";
...
export default function ImagePage() {
  ...
  const handleReferenceImageUpload = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const data = await uploadDemoImage(file);
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      // Restore presets after a failed request.
      setGeneratedImages(presetImages);
    } finally {
  ...
  const suggestionOptions = [
    { icon: "P", key: "portrait" as const },
    { icon: "A", key: "architecture" as const },
    { icon: "C", key: "cinematic" as const },
    { icon: "D", key: "product" as const },
    { icon: "R", key: "artistic" as const },
  ];
